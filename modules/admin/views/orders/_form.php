...
<div class="orders-form">
    ...
    <?= $form->field($model, 'status')->dropDownList([ 'Принят' => 'Принят', 'Одобрен' => 'Одобрен', 'Ожидание оплаты' => 'Ожидание оплаты', 'Укомплектован' => 'Укомплектован', 'Доставка в Россию' => 'Доставка в Россию', 'Доставка по России' => 'Доставка по России', 'Выполнен' => 'Выполнен', ]) ?>
